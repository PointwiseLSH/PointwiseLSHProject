...
allTempJaccardSim = []
allTempNMI = []
totalResultFile = open('CROSS_POINTWISELSH_totalResult','a')
...
for numberHFs in [2,3,5,9,15,25,31,51,71,101,151,201]:
	for numberRadius in [4,5,9,15,25,31,51,71,101,151,201]:
		...
		for c in range(1,6):
			...
			fileContainer = open('Pointwise LSH Clustering Experiment -optimization- ('+usedDataset[35:-4]+') HFs_'+ str(numberHFs)+'_R_'+str(numberRadius), 'a')
			fileContainer.write('\n')
