	...
	for numberHFs in [2,3,5,9,15,25,31,51,71,101,151,201]:
		for numberRadius in [2,3,5,9,15,25,31,51,71,101,151,201]:
			...
			#------------------------------------------------------------------------------
				...
				fileContainer = open('Final_Report Pointwise LSH Clustering SegDiff'+str(segment)+'Overlap Experiment -- Optimization '+usedDataset[35:-4], 'a')
				fileContainer.write('\n')
				fileContainer.write('Welcome to our experiment : -Segmentation Two segments with Overlapping- HFs_'+ str(numberHFs)+'_R_'+str(numberRadius))
