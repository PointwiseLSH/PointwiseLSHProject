...
fileContainer = open('Pointwise LSH Clustering Experiment ('+usedDataset[35:-4]+') HFs_'+ str(numberHFs)+'_R_'+str(numberRadius), 'a')
fileContainer.write('\n')
...
def	ccr(groundTruth, predictionResult):
	...
	while(flag):
		...
		if ii == 16:
			flag = False
	return (maxIntersection/1600.0)*100
		

print jaccardSim(I5SIM3DatasetTrueClassification, clusteringResults)

print ccr(I5SIM3DatasetTrueClassification, clusteringResults)
# print labelAssignment	
fileContainer.write('\n')
fileContainer.write('The Correct Clustering Rate is : '+ str(ccr(I5SIM3DatasetTrueClassification, clusteringResults)))
fileContainer.write('\n')
fileContainer.write('The clustering Jaccard Similarity is : '+ str(jaccardSim(I5SIM3DatasetTrueClassification, clusteringResults)))
print datasetSize
wholeTrueClasses = np.zeros(datasetSize)
for i, trueClass in enumerate(I5SIM3DatasetTrueClassification):
